...
public class Swerve extends SubsystemBase{
    ...
    public void moveLeft(){
        SwerveModuleState fLmoveRight= new SwerveModuleState(-1, Rotation2d.fromDegrees(90));
        SwerveModuleState fRmoveRight = new SwerveModuleState(-1, Rotation2d.fromDegrees(90));
        SwerveModuleState bLmoveRight= new SwerveModuleState(-1, Rotation2d.fromDegrees(90));
        SwerveModuleState bRmoveRight = new SwerveModuleState(-1, Rotation2d.fromDegrees(90));

        frontLeft.setState(fLmoveRight);
        frontRight.setState(fRmoveRight);
        backLeft.setState(bLmoveRight);
        backRight.setState(bRmoveRight);
