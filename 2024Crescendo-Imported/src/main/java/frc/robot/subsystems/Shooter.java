...
public class Shooter extends SubsystemBase {
  ...
  public void runShooter(double topVelocity, double topAcceleration, double bottomVelocity, double bottomAcceleration) {
    topLeftMotor.setControl(new VelocityVoltage(-topVelocity).withAcceleration(-topAcceleration));
    topRightMotor.setControl(new VelocityVoltage(topVelocity).withAcceleration(topAcceleration));
    
    bottomLeftMotor.setControl(new VelocityVoltage(-bottomVelocity).withAcceleration(-bottomAcceleration));
    bottomRightMotor.setControl(new VelocityVoltage(bottomVelocity).withAcceleration(bottomAcceleration));
  }
  ...
  public void stopMotors() {
    topLeftMotor.setControl(new VelocityVoltage(0.0).withAcceleration(0.0));
    topRightMotor.setControl(new VelocityVoltage(0.0).withAcceleration(0.0));
    
    bottomLeftMotor.setControl(new VelocityVoltage(0.0).withAcceleration(0.0));
    bottomRightMotor.setControl(new VelocityVoltage(0.0).withAcceleration(0.0));
  }
